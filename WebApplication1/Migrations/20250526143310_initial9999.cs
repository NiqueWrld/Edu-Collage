...
{
    /// <inheritdoc />
    public partial class initial9999 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryBookings", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK_LibraryBookings_AspNetUsers_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LibraryBookings_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Performance_AspNetUsers_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Performance_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleLecturers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModuleLecturers_AspNetUsers_LecturerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudyMaterials_AspNetUsers_UploadedById",
                        column: x => x.UploadedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudyMaterials_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "ModuleId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeedbackFromLecturer = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LibraryBookings_IdentityUserId",
                table: "LibraryBookings",
                column: "IdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LibraryBookings_StudentId",
                table: "LibraryBookings",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModuleLecturers_ModuleId",
                table: "ModuleLecturers",
                column: "ModuleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Performance_IdentityUserId",
                table: "Performance",
                column: "IdentityUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudyMaterials_ModuleId",
